...
(1, 'VipHosting_one_data_types', ''),
(2, 'VipHosting_one_data_delete', '');
...
(1, 'Admin', 'Test', 'vmpanel', 1, 123, 1600989846, 1);
...
(143, 1, 'mail@test.com', 'fn8ff5j75puzw1vv', 1, 1, 1600989865, 1600989865);
...
--
-- Tablo için tablo yapısı `VipHosting_mailer`
--

CREATE TABLE `VipHosting_mailer` (
  `id` int(11) NOT NULL,
  `key` varchar(355) COLLATE utf8_turkish_ci NOT NULL,
  `value` text COLLATE utf8_turkish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_turkish_ci;
...
--
-- Tablo döküm verisi `VipHosting_mailer`
--

INSERT INTO `VipHosting_mailer` (`id`, `key`, `value`) VALUES
...
--
-- Tablo için indeksler `VipHosting_mailer`
--
ALTER TABLE `VipHosting_mailer`
  ADD PRIMARY KEY (`id`),
  ADD KEY `key` (`key`(255));
...
--
-- Tablo için AUTO_INCREMENT değeri `VipHosting_mailer`
--
ALTER TABLE `VipHosting_mailer`
